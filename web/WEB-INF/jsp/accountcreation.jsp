...
<tr >
    ...
    <td width="1200" valign="top">
		...
		<tr>
			<td>
				<form:form commandName="commandAddAccount">
                                    <form:errors path="*" />
				  <table cellspacing="5" cellpadding="3">	
				
                                      <tr><td>PASSWORD:</td><td> <form:input path="pass" type="password" name="pass" required="required"/></td></tr>
				      <tr><td>AMOUNT:</td><td> <form:input path="solde" name="solde" required="required" placeholder="Amount here"/></td></tr>
